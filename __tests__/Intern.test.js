...
describe("Intern", () => {
    describe("Initialization", () => {
        ...
        it("Should throw an error if provided a non string value for name", () =>{
            //Act
            const cb1 = () => new Intern(987, 2584, "bradcoleman60@gmail.com", "USC");
        ...
        it("Should throw an error if provided a non number for id", () =>{
            //Act
            const cb2 = () => new Intern("Brad", "not a number", "bradcoleman60@gmail.com", "USC");
        ...
        it("Should throw an error if provided a non email address for email", () =>{
            //Act
            const cb3 = () => new Intern("Brad Coleman", 999 , "bradcoleman60", "USC");
        ...
        it("Should return role when getRole() function is called", () => {
            //Act
            const cb1 = new Intern("Brad Coleman", 58644, "bradcoleman60@gmail.com", "USC");
